...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var toastEl = document.querySelector('#myToast');
  var toast = new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Toast(toastEl, {
    delay: 4000
  });
...
document.addEventListener('DOMContentLoaded', function () {
  var cards = Array.from(document.querySelectorAll('.president-card'));
  var modalElement = document.getElementById('infoModal');
  var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Modal(modalElement);
  ...
  var presidentOrder = ['macron', 'hollande', 'sarkozy', 'chirac', 'mitterrand'];
  var currentPresidentIndex = 0;
  cards.forEach(function (card) {
    card.addEventListener('click', function () {
      var key = card.dataset.president;
  ...
  function showPresidentInfo(key) {
    ...
    setTimeout(function () {
      ...
      popovers.forEach(function (el) {
        return new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Popover(el);
      });
    }, 200);
  }
